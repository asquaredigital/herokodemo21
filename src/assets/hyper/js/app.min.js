...
function(a) {
	...
	t.prototype._selectOptionsFromConfig=function() {
		...
		if(t) {
			switch(t.sideBarTheme) {
				case"default": a("#default-check").prop("checked", !0);
				break;
				case"light": a("#light-check").prop("checked", !0);
				break;
				case"dark": a("#dark-check").prop("checked", !0)
			}
			(t.isBoxed?a("#boxed-check"):a("#fluid-check")).prop("checked", !0),
	...
	t.prototype.init=function() {
		...
		a("input[type=radio][name=width]").change(function() {
			switch(a(this).val()) {
				case"fluid": a.App.activateFluid();
				break;
				case"boxed": a.App.activateBoxed()
			}
		}
		),
		a("input[type=radio][name=theme]").change(function() {
			switch(a(this).val()) {
				case"default": a.App.activateDefaultSidebarTheme();
				break;
				case"light": a.App.activateLightSidebarTheme();
				break;
				case"dark": a.App.activateDarkSidebarTheme()
			}
		}
		),
		a("input[type=radio][name=compact]").change(function() {
			switch(a(this).val()) {
				case"fixed": a.App.deactivateCondensedSidebar(), a.App.deactivateScrollableSidebar();
				break;
				case"scrollable": a.App.activateScrollableSidebar();
				break;
				case"condensed": a.App.activateCondensedSidebar()
			}
		}
		),
		a("input[type=radio][name=color-scheme-mode]").change(function() {
			switch(a(this).val()) {
				case"light": a.App.deactivateDarkMode(), a.App.activateDefaultSidebarTheme(), a("#default-check").prop("checked", !0), a("input[type=radio][name=theme]").prop("disabled", !1);
				break;
				case"dark": a.App.activateDarkMode(), a("#dark-check").prop("checked", !0)
			}
		}
		),
...
function(a) {
	...
	o="dark",
	n= {
		sideBarTheme: e, isBoxed:!1, isCondensed:!1, isScrollable:!1, isDarkModeEnabled:!1
	}
	;
	...
	t.prototype._applyConfig=function() {
		...
		switch(this._config=this._getStoredConfig(), a.LeftSidebar.init(), t._config.sideBarTheme) {
			case o: t.activateDarkSidebarTheme();
			break;
			case i: t.activateLightSidebarTheme()
		}
	...
	t.prototype.activateDarkMode=function() {
		...
		a.LeftSidebar.activateDarkTheme(),
		this._saveConfig( {
			isDarkModeEnabled: !0, sideBarTheme:o
		}
		)
	}
	,
...
function(n) {
	...
	t.prototype.initDateRange=function() {
		var i= {
			cancelClass: "btn-light", applyButtonClasses:"btn-success"
		}
		;
	...
	t.prototype.initMaxlength=function() {
		var i= {
			warningClass: "badge badge-success", limitReachedClass:"badge badge-danger", separator:" out of ", preText:"You typed ", postText:" chars available.", placement:"bottom"
		}
		;
...
function(s) {
	...
	t.prototype.send=function(t, e, a, i, o, n, r, d) {
		r= {
			heading: t, text:e, position:a, loaderBg:i, icon:o, hideAfter:n=n||3e3, stack:r=r||1
		}
		;
		r.showHideTransition=d||"fade",
		s.toast().reset("all"),
		s.toast(r)
	}
	,
	s.NotificationApp=new t,
	s.NotificationApp.Constructor=t
}
	...
	t.prototype.initSyntaxHighlight=function() {
		e(document).ready(function(t) {
			document.querySelectorAll("pre span.escape").forEach(function(t, e) {
				...
				o<i.length;
				o++)i[o].trim()&&(a=Math.min(i[o].search(/\S/), a));
				for(var n=[], o=0;
				o<i.length;
				o++)n.push(i[o].replace(new RegExp("^ {"+a+"}", "g"), ""));
				t.innerText=n.join("\n")
			}
...
function(e) {
	...
	t.prototype.init=function() {
		...
		e.RightBar.init();
		var t=this.$body.data("layoutConfig");
		window.sessionStorage&&t&&t.hasOwnProperty("showRightSidebarOnStart")&&t.showRightSidebarOnStart&&(sessionStorage.getItem("_HYPER_VISITED_")||(e.RightBar.toggleRightSideBar(), sessionStorage.setItem("_HYPER_VISITED_", !0))),
		e.Portlet.init(),
